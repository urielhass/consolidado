...
import br.com.stock.bd.connection.JPAConnection;
import br.com.stock.bd.interfaces.CrudDAO;
...
//----
	...
	/**
	 * Metodo para execucao de query nativa do SQL.
	 * 
	 * @param sql - query de execucao.
